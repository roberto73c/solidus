...
# Create solidus user
RUN adduser --system --group --disabled-password solidus && \
	mkdir -p /wallet /home/solidus/.bitsolidus && \
	chown -R solidus:solidus /home/solidus/.bitsolidus && \
	chown -R solidus:solidus /wallet

# Contains the blockchain
VOLUME /home/solidus/.bitsolidus
...
# switch to user solidus
USER solidus

ENTRYPOINT ["solidusd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
