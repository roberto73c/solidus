...
gsigs = 'https://github.com/roberto73c/gitian.sigs.git'
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/roberto73c/solidus', help='Specify the URL of the repository. Default is %(default)s')
